...
public final class Example1 extends ExperimentSetCreator {
   ...
   *          the context
   */
  private final void __createExperimentSet(
      final ExperimentSetContext isc) {
   ...
   */
  private final void __createInstanceRuns_1_A(
      final InstanceRunsContext irc) {
   ...
   *          the Instance runs context
   */
  private final void __createInstanceRuns_1_B(
      final InstanceRunsContext irc) {
   ...
   *          the Instance runs context
   */
  private final void __createInstanceRuns_1_C(
      final InstanceRunsContext irc) {
   ...
   *          the Instance runs context
   */
  private final void __createInstanceRuns_2_D(
      final InstanceRunsContext irc) {
   ...
   *          the Instance runs context
   */
  private final void __createInstanceRuns_2_B(
      final InstanceRunsContext irc) {
    irc.setInstance("Second Instance"); //$NON-NLS-1$
    try (final RunContext rc = irc.createRun()) {
   ...
   *          the Instance runs context
   */
  private final void __createInstanceRuns_2_C(
      final InstanceRunsContext irc) {
    irc.setInstance("Third Instance"); //$NON-NLS-1$
    try (final RunContext rc = irc.createRun()) {
