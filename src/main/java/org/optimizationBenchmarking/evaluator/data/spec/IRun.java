...
public interface IRun extends IElementSet, IMatrix {
   ...
   * {@link org.optimizationBenchmarking.evaluator.data.spec.EDimensionType#isSolutionQualityMeasure()
   ...
   * <li>If dimension {@code column} represents a
   * {@link org.optimizationBenchmarking.evaluator.data.spec.EDimensionType#isTimeMeasure()
