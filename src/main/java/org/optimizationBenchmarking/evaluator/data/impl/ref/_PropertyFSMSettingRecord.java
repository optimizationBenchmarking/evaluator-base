  ...
  synchronized final void _mergePropertyValue(final String propertyName,
    ...
    if (this.m_refCount != 0) {
      ...
      if (!(this.m_propertyValue.equals(propertyValue))) {
        this.m_dead = true;
        // throw new IllegalArgumentException((((((("Value update of
        // property '" //$NON-NLS-1$
        // + this.m_propertyName) + "' cannot change property value, but
        // new value is '")//$NON-NLS-1$
    ...
    this.m_propertyValueDesc = AbstractNamedElement
        .mergeDescriptions(this.m_propertyValueDesc, propertyValueDesc);
  }
}
