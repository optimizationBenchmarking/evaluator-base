...
import org.optimizationBenchmarking.evaluator.data.impl.shadow.DataSelection._CompiledSelection;
...
public class ShadowExperimentSet<OT extends IDataElement> extends //
    _ShadowNamedElementSet<OT, IExperimentSet, IExperiment>
  ...
  public ShadowExperimentSet(final OT owner, final IExperimentSet shadow,
      final Collection<? extends IExperiment> experimentSelection,
      final ShadowDimensionSet dimensions, final ShadowFeatureSet features,
   ...
   *          the selection
   */
  public ShadowExperimentSet(final OT owner,
