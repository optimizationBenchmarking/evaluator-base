...
public class DimensionDirectionParser
    extends InstanceParser<EDimensionDirection> {
   ...
   */
  public static final String getHumanReadable(
      final EDimensionDirection dir) {
    if (dir == null) {
      throw new IllegalArgumentException(
