 ...
 * {@link org.optimizationBenchmarking.evaluator.data.spec.IFeatureSet}
 * interface.
 */
public class AbstractFeatureSet
    extends _AbstractPropertySet<IFeatureSetting> implements IFeatureSet {

  /**
   * Create the abstract feature set. If {@code owner==null}, you must
   * later set it via
   * {@link org.optimizationBenchmarking.evaluator.data.impl.abstr.AbstractExperimentSet#own(AbstractFeatureSet)}
   * .
   *
   * @param owner
   *          the owner
  ...
  /**
   * Own an
   * {@link org.optimizationBenchmarking.evaluator.data.impl.abstr.AbstractFeature}
   * .
   *
   * @param feature
