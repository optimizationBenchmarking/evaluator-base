...
public class Dimension extends _NamedIDObject implements IDimension {
  ...
  Dimension(final String name, final String desc,
    ...
    switch (this.m_primitiveType) {
      case BYTE: {
        this.m_defaultLower = Byte
            .valueOf((byte) (parser.getLowerBoundLong()));
        this.m_defaultUpper = Byte
            .valueOf((byte) (parser.getUpperBoundLong()));
        break;
      }
      case SHORT: {
        this.m_defaultLower = Short
            .valueOf((short) (parser.getLowerBoundLong()));
        this.m_defaultUpper = Short
            .valueOf((short) (parser.getUpperBoundLong()));
        break;
      }
      case INT: {
        this.m_defaultLower = Integer
            .valueOf((int) (parser.getLowerBoundLong()));
        this.m_defaultUpper = Integer
            .valueOf((int) (parser.getUpperBoundLong()));
        break;
      }
      case LONG: {
      ...
      case FLOAT: {
        this.m_defaultLower = Float
            .valueOf((float) (parser.getLowerBoundDouble()));
        this.m_defaultUpper = Float
            .valueOf((float) (parser.getUpperBoundDouble()));
        break;
      }
      case DOUBLE: {
