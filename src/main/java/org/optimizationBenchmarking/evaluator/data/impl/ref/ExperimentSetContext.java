...
public final class ExperimentSetContext extends _FSM
    implements IExperimentSetContext {

  /** a dimension set context was created */
  private static final int STATE_DIMENSION_SET_CONTEXT_CREATED = (_FSM.STATE_OPEN
      + 1);
  /** a dimension set context entered the before-open state */
  private static final int STATE_DIMENSION_SET_CONTEXT_BEFORE_OPEN = (ExperimentSetContext.STATE_DIMENSION_SET_CONTEXT_CREATED
      + 1);
  /** a dimension set context entered the after-open state */
  private static final int STATE_DIMENSION_SET_CONTEXT_AFTER_OPEN = (ExperimentSetContext.STATE_DIMENSION_SET_CONTEXT_BEFORE_OPEN
      + 1);
  /** a dimension set context entered the closed state */
  private static final int STATE_DIMENSION_SET_CONTEXT_CLOSED = (ExperimentSetContext.STATE_DIMENSION_SET_CONTEXT_AFTER_OPEN
      + 1);
  /** a dimension set context entered the closed state */
  private static final int STATE_DIMENSION_SET_OBTAINED = (ExperimentSetContext.STATE_DIMENSION_SET_CONTEXT_CLOSED
      + 1);

  /** a instance set context was created */
  private static final int STATE_INSTANCE_SET_CONTEXT_CREATED = (ExperimentSetContext.STATE_DIMENSION_SET_OBTAINED
      + 1);
  /** a instance set context entered the before-open state */
  private static final int STATE_INSTANCE_SET_CONTEXT_BEFORE_OPEN = (ExperimentSetContext.STATE_INSTANCE_SET_CONTEXT_CREATED
      + 1);
  /** a instance set context entered the after-open state */
  private static final int STATE_INSTANCE_SET_CONTEXT_AFTER_OPEN = (ExperimentSetContext.STATE_INSTANCE_SET_CONTEXT_BEFORE_OPEN
      + 1);
  /** a instance set context entered the closed state */
  private static final int STATE_INSTANCE_SET_CONTEXT_CLOSED = (ExperimentSetContext.STATE_INSTANCE_SET_CONTEXT_AFTER_OPEN
      + 1);
  /** a feature set context entered the closed state */
  private static final int STATE_FEATURE_SET_CONTEXT_OBTAINED = (ExperimentSetContext.STATE_INSTANCE_SET_CONTEXT_CLOSED
      + 1);
  /** a instance set context entered the closed state */
  private static final int STATE_INSTANCE_SET_OBTAINED = (ExperimentSetContext.STATE_FEATURE_SET_CONTEXT_OBTAINED
      + 1);

  /** a experiment set context was created */
  private static final int STATE_EXPERIMENT_SET_CONTEXT_CREATED = (ExperimentSetContext.STATE_INSTANCE_SET_OBTAINED
      + 1);
  /** a experiment set context entered the before-open state */
  private static final int STATE_EXPERIMENT_SET_CONTEXT_BEFORE_OPEN = (ExperimentSetContext.STATE_EXPERIMENT_SET_CONTEXT_CREATED
      + 1);
  /** a experiment set context entered the after-open state */
  private static final int STATE_EXPERIMENT_SET_CONTEXT_AFTER_OPEN = (ExperimentSetContext.STATE_EXPERIMENT_SET_CONTEXT_BEFORE_OPEN
      + 1);
  /** a experiment set context entered the closed state */
  private static final int STATE_EXPERIMENT_SET_CONTEXT_CLOSED = (ExperimentSetContext.STATE_EXPERIMENT_SET_CONTEXT_AFTER_OPEN
      + 1);
  /** a experiment set context has been obtained */
  private static final int STATE_EXPERIMENT_SET_OBTAINED = (ExperimentSetContext.STATE_EXPERIMENT_SET_CONTEXT_CLOSED
      + 1);
  /** a experiment set context has been taken */
  private static final int STATE_EXPERIMENT_SET_TAKEN = (ExperimentSetContext.STATE_EXPERIMENT_SET_OBTAINED
      + 1);
  ...
  static {
    STATE_NAMES = new String[ExperimentSetContext.STATE_EXPERIMENT_SET_TAKEN
        + 1];
  ...
  /** {@inheritDoc} */
  @Override
  public final void declareParameter(final String name,
      final String desc) {
