 ...
 * interface.
 */
public abstract class AbstractFeature extends AbstractProperty
    implements IFeature {
   ...
   * set it via
   * {@link org.optimizationBenchmarking.evaluator.data.impl.abstr.AbstractFeatureSet#own(AbstractFeature)}
   * .
   *
   * @param owner
   *          the owner
  ...
  /**
   * Own an
   * {@link org.optimizationBenchmarking.evaluator.data.impl.abstr.AbstractFeatureValue}
   * .
   *
   * @param featureValue
