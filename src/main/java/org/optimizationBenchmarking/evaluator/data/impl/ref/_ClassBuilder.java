 ...
 */
final class _ClassBuilder
    implements Callable<Parser<DataPoint>>, Comparator<Dimension> {
  ...
  _ClassBuilder(final DimensionSet dimensions, final Logger logger) {
    ...
    this.m_runColumnsRowIteratorClass = ("_DynaRunColumnsRowIterator" //$NON-NLS-1$
        + hc);
  }
  ...
  private final void __dataPointEquals(final MemoryTextOutput sb) {
    ...
    for (final EPrimitiveType t : this.m_primitiveTypes) {
      ...
      if (t.isFloat()) {
        sb.append('(');
        sb.append(Compare.class.getCanonicalName());
        sb.append(".compare(this.m"); //$NON-NLS-1$
        sb.append(i);
  ...
  private final void __dataPointValidateAfter(final MemoryTextOutput sb) {
    ...
    sb.append(DataPoint.class.getCanonicalName());
    sb.append(
        " before) {boolean later = false; String reason = null; final "); //$NON-NLS-1$
    sb.append(this.m_dataPointClass);
    sb.append(" c = (("); //$NON-NLS-1$
    sb.append(this.m_dataPointClass);
   ...
   *          the string builder
   */
  private final void __dataPointIMatrixAggregate(
      final MemoryTextOutput sb) {
    int i;
  ...
  private final void __dataPointToArray2(final MemoryTextOutput sb) {
    ...
    sb.append(
        "public <T> T[] toArray(final T[] a) { final Object[] dest; "); //$NON-NLS-1$
  ...
  private final void __dataPointSelect(final MemoryTextOutput sb) {
    ...
    if (this.m_primitiveTypes.length <= 0) {
      ...
      sb.append(clazz.getCanonicalName());
      sb.append(
          "[i]; System.arraycopy(tmp, 0, dest, 0, i); } return new "); //$NON-NLS-1$
   ...
   *          the string parser builder
   */
  private final void __factoryParseGetOutputClass(
      final MemoryTextOutput sb) {
  ...
  private final void __runColumnsConstructor(final MemoryTextOutput sb) {
    ...
    if (this.m_matrixChoice != Boolean.FALSE) {
      sb.append(
          "@Override public final boolean isIntegerMatrix(){return "); //$NON-NLS-1$
