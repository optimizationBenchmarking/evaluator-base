...
public final class Parameter extends Property<ParameterValue>
  ...
  public static final String PARAMETER_ALGORITHM_CLASS = (Parameter.PARAMETER_ALGORITHM
      + "Class"); //$NON-NLS-1$

  /** the string indicating that the algorithm name follows: {@value} */
  public static final String PARAMETER_ALGORITHM_NAME = (Parameter.PARAMETER_ALGORITHM
      + "Name"); //$NON-NLS-1$
   ...
   * follows: {@value}
   */
  public static final String PARAMETER_INITIALIZER_CLASS = (Parameter.PARAMETER_INITIALIZER
      + "Class"); //$NON-NLS-1$
   ...
   * follows: {@value}
   */
  public static final String PARAMETER_INITIALIZER_NAME = (Parameter.PARAMETER_INITIALIZER
      + "Name"); //$NON-NLS-1$
   ...
   * {@link org.optimizationBenchmarking.evaluator.data.impl.ref.Experiment}
   *
   * @param experiment
