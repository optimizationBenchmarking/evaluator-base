...
public abstract class AbstractDimensionSet extends AbstractNamedElementSet
   ...
   * later set it via
   * {@link org.optimizationBenchmarking.evaluator.data.impl.abstr.AbstractExperimentSet#own(AbstractDimensionSet)}
   * .
   *
   * @param owner
   *          the owner
  ...
  /**
   * Own an
   * {@link org.optimizationBenchmarking.evaluator.data.impl.abstr.AbstractDimension}
   * .
   *
   * @param dimension
