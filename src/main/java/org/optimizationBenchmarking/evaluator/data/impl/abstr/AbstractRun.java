 ...
 * {@link org.optimizationBenchmarking.evaluator.data.spec.IRun} interface.
 */
public abstract class AbstractRun extends AbstractElementSet
    implements IRun {
   ...
   * via
   * {@link org.optimizationBenchmarking.evaluator.data.impl.abstr.AbstractInstanceRuns#own(AbstractRun)}
   * .
   *
   * @param owner
   *          the owner
