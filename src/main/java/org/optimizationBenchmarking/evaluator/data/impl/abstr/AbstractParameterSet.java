...
public abstract class AbstractParameterSet extends
   ...
   * later set it via
   * {@link org.optimizationBenchmarking.evaluator.data.impl.abstr.AbstractExperimentSet#own(AbstractParameterSet)}
   * .
   *
   * @param owner
   *          the owner
  ...
  /**
   * Own an
   * {@link org.optimizationBenchmarking.evaluator.data.impl.abstr.AbstractParameter}
   * .
   *
   * @param parameter
