...
final class _EDIContentHandler extends DelegatingHandler {
  ...
  /** {@inheritDoc} */
  @Override
  public final void doError(final SAXParseException e)
      throws SAXException {
    try {
  ...
  private final void __startDimension(final Attributes atts) {
    ...
    this.m_context
        .dimensionSetParser(NumberParser.createNumberParser(pt, lb, ub));
  }
  ...
  private final void __startInstanceRuns(final Attributes atts) {
    ...
    this.m_context
        .runsSetInstance(DelegatingHandler.getAttributeNormalized(atts,
