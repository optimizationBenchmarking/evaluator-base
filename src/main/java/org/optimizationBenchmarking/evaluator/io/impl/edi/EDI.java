...
public enum EDI implements IXMLFileType {
  ...
  URI.create(
      "http://www.optimizationBenchmarking.org/formats/experimentDataInterchange/experimentDataInterchange.1.0.xsd") //$NON-NLS-1$
      .normalize();
  ...
  static {
    ATTRIBUTE_VALUE_DIMENSION_DATA_TYPE = new String[EPrimitiveType.INSTANCES
        .size()];
    EDI.ATTRIBUTE_VALUE_DIMENSION_DATA_TYPE[EPrimitiveType.BYTE
        .ordinal()] = "byte"; //$NON-NLS-1$
    EDI.ATTRIBUTE_VALUE_DIMENSION_DATA_TYPE[EPrimitiveType.SHORT
        .ordinal()] = "short"; //$NON-NLS-1$
    EDI.ATTRIBUTE_VALUE_DIMENSION_DATA_TYPE[EPrimitiveType.INT
        .ordinal()] = "int"; //$NON-NLS-1$
    EDI.ATTRIBUTE_VALUE_DIMENSION_DATA_TYPE[EPrimitiveType.LONG
        .ordinal()] = "long"; //$NON-NLS-1$
    EDI.ATTRIBUTE_VALUE_DIMENSION_DATA_TYPE[EPrimitiveType.FLOAT
        .ordinal()] = "float"; //$NON-NLS-1$
  ...
  static final EDimensionType _parseDimensionType(final String string) {
    ...
    throw new IllegalArgumentException(
        ('\'' + string) + "' is not a valid dimension type identifier."); //$NON-NLS-1$
  }
  ...
  static final EPrimitiveType _parseDataType(final String string) {
    ...
    throw new IllegalArgumentException(
        ('\'' + string) + "' is not a valid data type identifier."); //$NON-NLS-1$
  }
