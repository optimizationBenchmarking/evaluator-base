package org.optimizationBenchmarking.evaluator.io.impl.bbob;
 ...
 * <p>
 * A class for loading
 * <a href="http://coco.gforge.inria.fr/doku.php">COCO/BBOB</a> data sets
 ...
 * </p>
 */
public class BBOBInput extends FileInputTool<IExperimentSetContext>
  ...
  public static final void makeBBOBInstanceSet(
    ...
    String fidDesc, dimDesc, noptDesc, symDesc, symDescSym, symDescAsym, //
        sepDesc, sepFullyDesc, sepPartiallyDesc, sepNoneDesc, condDesc,
        condOKDesc, //
        condIllDesc, noptUniDesc, noptMultiDesc, optOnBoundDesc,
        optOnBoundTrueDesc, //
        optOnBoundFalseDesc, stepsDesc, stepsTrueDesc, stepsFalseDesc,
        ruggedDesc, //
    ...
    for (final byte bdim : BBOBInput.DIMENSIONS) {
      ...
      try (final IInstanceContext i = esb.createInstance()) {
        ...
        i.setFeatureValue(BBOBInput.FEATURE_FUNCTION_ID, fidDesc, ints[10],
            null);
      ...
      try (final IInstanceContext i = esb.createInstance()) {
        ...
        i.setFeatureValue(BBOBInput.FEATURE_FUNCTION_ID, fidDesc, ints[11],
            null);
      ...
      try (final IInstanceContext i = esb.createInstance()) {
        ...
        i.setFeatureValue(BBOBInput.FEATURE_FUNCTION_ID, fidDesc, ints[12],
            null);
      ...
      try (final IInstanceContext i = esb.createInstance()) {
        ...
        i.setFeatureValue(BBOBInput.FEATURE_FUNCTION_ID, fidDesc, ints[13],
            null);
      ...
      try (final IInstanceContext i = esb.createInstance()) {
        ...
        i.setFeatureValue(BBOBInput.FEATURE_FUNCTION_ID, fidDesc, ints[14],
            null);
      ...
      try (final IInstanceContext i = esb.createInstance()) {
        ...
        i.setFeatureValue(BBOBInput.FEATURE_FUNCTION_ID, fidDesc, ints[15],
            null);
      ...
      try (final IInstanceContext i = esb.createInstance()) {
        ...
        i.setFeatureValue(BBOBInput.FEATURE_FUNCTION_ID, fidDesc, ints[16],
            null);
      ...
      try (final IInstanceContext i = esb.createInstance()) {
        ...
        i.setFeatureValue(BBOBInput.FEATURE_FUNCTION_ID, fidDesc, ints[17],
            null);
      ...
      try (final IInstanceContext i = esb.createInstance()) {
        ...
        i.setFeatureValue(BBOBInput.FEATURE_FUNCTION_ID, fidDesc, ints[18],
            null);
      ...
      try (final IInstanceContext i = esb.createInstance()) {
        ...
        i.setFeatureValue(BBOBInput.FEATURE_FUNCTION_ID, fidDesc, ints[19],
            null);
      ...
      try (final IInstanceContext i = esb.createInstance()) {
        ...
        i.setFeatureValue(BBOBInput.FEATURE_FUNCTION_ID, fidDesc, ints[20],
            null);
      ...
      try (final IInstanceContext i = esb.createInstance()) {
        ...
        i.setFeatureValue(BBOBInput.FEATURE_FUNCTION_ID, fidDesc, ints[21],
            null);
      ...
      try (final IInstanceContext i = esb.createInstance()) {
        ...
        i.setFeatureValue(BBOBInput.FEATURE_FUNCTION_ID, fidDesc, ints[22],
            null);
      ...
      try (final IInstanceContext i = esb.createInstance()) {
        ...
        i.setFeatureValue(BBOBInput.FEATURE_FUNCTION_ID, fidDesc, ints[23],
            null);
      ...
      try (final IInstanceContext i = esb.createInstance()) {
        ...
        i.setFeatureValue(BBOBInput.FEATURE_FUNCTION_ID, fidDesc, ints[24],
            null);
  ...
  /** {@inheritDoc} */
  @Override
  protected void path(final IOJob job, final IExperimentSetContext data,
