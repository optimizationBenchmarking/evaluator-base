package org.optimizationBenchmarking.evaluator.io.impl;
 ...
 */
public final class ExperimentSetInputParser
    extends InstanceParser<IExperimentSetInput> {
  ...
  ExperimentSetInputParser() {
    super(IExperimentSetInput.class,
        ExperimentSetInputParser.__prefixes());
  }
  ...
  private static final String[] __prefixes() {
    ...
    ReflectionUtils.addPackageOfClassToPrefixList(CSVEDIInput.class,
        paths);
