...
public final class EvaluationModulesBuilder
  ...
  public synchronized final void setRootConfiguration(
    ...
    this.fsmFlagsAssertAndUpdate(FSM.FLAG_NOTHING,
        (EvaluationModulesBuilder.FLAG_ROOT_CONFIG_SET
            ...
            | EvaluationModulesBuilder.FLAG_MODULE_ADDED),
   ...
   *          the module entry
   */
  public synchronized final void addModule(
      final EvaluationModuleEntry entry) {
   ...
   */
  public synchronized final EvaluationModuleEntryBuilder addModule() {
    this.fsmStateAssert(BuilderFSM.STATE_OPEN);
    this.fsmFlagsAssertAndUpdate(FSM.FLAG_NOTHING, FSM.FLAG_NOTHING,
        EvaluationModulesBuilder.FLAG_MODULE_ADDED, FSM.FLAG_NOTHING);
    return new EvaluationModuleEntryBuilder(this);
  }
  ...
  protected synchronized final void afterChildClosed(
    ...
    if (child instanceof ConfigurationBuilder) {
      ...
      if (child instanceof EvaluationModuleEntryBuilder) {
        this.addModule(((EvaluationModuleEntryBuilder) child).getResult());
      } else {
  ...
  protected final EvaluationModules compile() {
    ...
    ArrayList<EvaluationModuleEntry> list;
    ArrayListView<EvaluationModuleEntry> view;
