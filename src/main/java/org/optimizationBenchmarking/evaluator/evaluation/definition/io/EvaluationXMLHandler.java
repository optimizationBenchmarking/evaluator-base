package org.optimizationBenchmarking.evaluator.evaluation.definition.io;
...
public final class EvaluationXMLHandler extends DelegatingHandler {
  ...
  /** the entry builder */
  private EvaluationModuleEntryBuilder m_entry;
  ...
  protected void doStartElement(final String uri, final String localName,
    ...
    if ((uri == null) || (EvaluationXML.NAMESPACE.equalsIgnoreCase(uri))) {
      ...
      if (EvaluationXML.ELEMENT_MODULE.equalsIgnoreCase(localName)) {
        ...
        this.m_entry
            .setModule(DelegatingHandler.getAttributeNormalized(attributes,
                EvaluationXML.NAMESPACE, EvaluationXML.ATTRIBUTE_CLASS));
        return;
      }
    }

    if ((uri == null) || (ConfigurationXML.CONFIG_XML.getNamespace()
