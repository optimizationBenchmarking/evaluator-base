...
public final class ModuleDescription extends DefinitionElement {
  ...
  public final boolean equals(final Object o) {
    ...
    if (o instanceof ModuleDescription) {
      ...
      return (Compare.equals(this.m_class, other.m_class) && //
          Compare.equals(this.getName(), other.getName()) && //
          Compare.equals(this.getDescription(), other.getDescription()));
    }
    return false;
  }
  ...
  public synchronized final Definition getParameters() {
    if (this.m_params == null) {
      this.m_params = DefinitionXMLInput.getInstance()
          .forClass(this.m_class, null);
    }
