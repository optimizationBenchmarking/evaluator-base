...
public class ModuleDescriptions extends ArrayListView<ModuleDescription> {
   ...
   * @return the description
   */
  public final ModuleDescription forModule(
  ...
  public final ModuleDescription forClass(final String clazz) {
    return this.forClass(this.parseModuleClass(clazz));
  }
   ...
   * @return the class
   */
  protected Class<? extends IEvaluationModule> parseModuleClass(
      final String module) {
    try {
      ...
      throw new RuntimeException(((("Failed to parse module class '" + //$NON-NLS-1$
          module) + '\'') + '.'), error);
    }
  }
  ...
  private static final class __Cmp
