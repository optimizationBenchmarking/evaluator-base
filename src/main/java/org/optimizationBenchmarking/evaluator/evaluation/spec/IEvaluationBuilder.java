...
public interface IEvaluationBuilder extends IConfigurableToolJobBuilder {
   ...
   */
  public abstract IEvaluationBuilder setInputData(
   ...
   */
  public abstract IEvaluationBuilder setInput(
   ...
   */
  public abstract IEvaluationBuilder setOutputDocument(
      final IDocument doc);
  ...
  /** {@inheritDoc} */
  @Override
  public abstract IRunnableToolJob create();
}
